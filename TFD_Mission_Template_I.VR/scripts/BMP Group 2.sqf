...
if (isServer) then {
//_team1 = [_pos2, east, "rhs_bmp2_vdv",[],[],[],[],[],0] call BIS_fnc_spawnGroup;
_pos1 = (getmarkerpos "marker_33") vectorAdd [0,0,225];
_para = "B_Parachute_02_F";
_vehicle = "rhs_bmp2_vdv" createVehicle (getmarkerpos "marker_33");
