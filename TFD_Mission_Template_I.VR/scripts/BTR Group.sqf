...
if (isServer) then {
//_team1 = [_pos3, east, "rhs_btr70_vdv",[],[],[],[],[],0] call BIS_fnc_spawnGroup;


_pos1 = (getmarkerpos "marker_27") vectorAdd [0,0,225];
_para = "B_Parachute_02_F";
_vehicle = "rhs_btr70_vdv" createVehicle (getmarkerpos "marker_27");
