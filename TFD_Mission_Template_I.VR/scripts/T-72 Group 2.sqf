...
if (isServer) then {
//_team1 = [_pos3, east, "rhs_t72bc_tv",[],[],[],[],[],0] call BIS_fnc_spawnGroup;


_pos1 = (getmarkerpos "marker_30") vectorAdd [0,0,225];
_para = "B_Parachute_02_F";
_vehicle = "rhs_t72bc_tv" createVehicle (getmarkerpos "marker_30");
